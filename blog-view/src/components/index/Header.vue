<template>
	<header ref="header">
		<div class="view">
			...
			<div class="bg1" style="background-image: url('https://cdn.jsdelivr.net/gh/xingchen121/Image/22/03/wallhaven-y83g77.png');"></div>
			<div class="bg2" style="background-image: url('https://cdn.jsdelivr.net/gh/xingchen121/Image/22/03/wallhaven-3zyl8v.png');"></div>
			<div class="bg3" style="background-image: url('https://cdn.jsdelivr.net/gh/xingchen121/Image/22/03/wallhaven-v9vzmm.jpg');" v-show="loaded"></div>
		</div>
		<div class="text-malfunction" data-word="Neko's Blog">
			<div class="line"></div>
		</div>
		<div class="wrapper">
